...
INSERT INTO users (name, email, role, photo)
VALUES
  (
    'user1', '', 'student', ''
  ),
  (
    'user2', '', 'student', 'https://resources.kamernet.nl/Content/images/placeholder/no-pic-user.png'
  ),
  (
    'user3', 'user3@ex.com', 'tutor',
    'https://resources.kamernet.nl/Content/images/placeholder/no-pic-user.png'
  ),
  (
    'user4', 'user4@ex.com', 'tutor',
    'https://resources.kamernet.nl/Content/images/placeholder/no-pic-user.png'
  ),
  (
    'user5', 'user5@ex.com', 'parent',
    'https://resources.kamernet.nl/Content/images/placeholder/no-pic-user.png'
  ),
  (
    'user6', 'user6@ex.com', 'parent',
    'https://resources.kamernet.nl/Content/images/placeholder/no-pic-user.png'
  ),
  (
    'user7', '', 'operation', 'https://resources.kamernet.nl/Content/images/placeholder/no-pic-user.png'
  ),
  (
    'user8', '', 'operation', 'https://resources.kamernet.nl/Content/images/placeholder/no-pic-user.png'
  );
