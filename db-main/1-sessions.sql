...
INSERT INTO sessions_students (
  status, feedback, rating_interaction, rating_cognition, rating_creativity,
  sessions_tutors_id, student_id
)
VALUES
  (TRUE,'feedback1',1,2,3,
    1,1),
  (TRUE,'feedback2',2,3,4,
    2,1),
  (TRUE,'feedback3',4,5,0,
    3,2),
  (TRUE,'feedback4',5,0,1,
    3,1),
  (TRUE,'feedback4',0,1,2,
    4,1);
