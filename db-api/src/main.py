...
from hooks import class_students, image_default, mqtt, session_tutor
...
app.on_inserted += session_tutor.on_inserted
app.on_deleted_item += session_tutor.on_deleted_item
